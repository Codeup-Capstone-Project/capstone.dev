...
@section('content')
        <section class="hero no-pad-bot" id="main-splash">
            ...
            {{-- Hero Graphics --}}
            <svg class="ninja" xmlns="http://www.w3.org/2000/svg" version="1.1" x="0" y="0" width="434.9" height="285.7" viewBox="0 0 434.9 285.7" xml:space="preserve"><style type="text/css">
                .st0{fill:#263238;}
                .st1{fill:#455A64;}
            ...
            <svg class="ninja-star hide-on-med-and-down" xmlns="http://www.w3.org/2000/svg" version="1.1" x="0" y="0" width="182" height="109" viewBox="0 0 182 109" xml:space="preserve"><style type="text/css">
                .st0{fill:#263238;}
                .st1{fill:#455A64;}
            ...
            <div class="container">
                <div class="row no-marg-bot pad-bot blue-grey-text text-darken-4">
                    ...
                    <div class="col s12 m12 l4">
                        ...
                        <p class="creator-button"><a href="http://www.linkedin.com/in/justindietert" class="btn waves-effect waves-teal blue-grey lighten-5 more-info" target="_blank">More about Justin</a></p>
                    </div>
                    ...
                    <div class="col s12 m12 l4">
                        ...
                        <p class="creator-button"><a href="http://www.linkedin.com/in/haskellj" class="btn waves-effect waves-teal blue-grey lighten-5 more-info" target="_blank">More about Jamie</a></p>
                    </div>
                </div>
            </div>
        </section>
