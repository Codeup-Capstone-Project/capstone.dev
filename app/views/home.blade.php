...
@section('content')
        <section class="hero no-pad-bot" id="main-splash">
            ...
            {{-- Hero Graphics --}}
            <svg class="ninja hide-on-med-and-down" xmlns="http://www.w3.org/2000/svg" version="1.1" x="0" y="0" width="434.9" height="285.7" viewBox="0 0 434.9 285.7" xml:space="preserve"><style type="text/css">
                .st0{fill:#263238;}
                .st1{fill:#455A64;}
            ...
            <div class="hero-tile-grid" aria-hidden="true">
